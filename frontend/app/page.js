  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-900">
      <div className="w-1/3 p-6 bg-gray-800 shadow-xl rounded-lg border border-gray-700">
        <h2 className="text-3xl mb-6 text-gray-200 font-semibold">Login</h2>
        <input
          type="email"
          placeholder="Email"
          value={email}
        ...
        />
        <button onClick={handleLogin} className="bg-blue-600 text-white p-3 w-full rounded-lg hover:bg-blue-700 transition-all duration-300">
          Login
        </button>
